...
JHtml::_('behavior.formvalidation');//JHtmlBehavior(Валидация формы при создании автобуса - заголовок статьи)
?>

<form action="index.php?option=com_buses&layout=edit&id=<?php echo $this->item->id;?>"
